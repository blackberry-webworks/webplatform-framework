 ...
 * @property {Number} id The id of the webview
...
Webview = function () {
    ...
    Webview.__defineGetter__("visible", function () {
        return visible;
    });
    
    Webview.__defineSetter__("visible", function (newVisibility) {
        visible = !!newVisibility;
        qnx.callExtensionMethod("webview.setVisible", id, visible);
    });

    Webview.__defineGetter__("active", function () {
        return active;
    });
    
    Webview.__defineSetter__("active", function (newActivity) {
        active = !!newActivity;
    ...
    Webview.__defineSetter__("zOrder", function (newZOrder) {
    ...
    Webview.prototype.create = function (onComplete) {
        ...
        //Based on this commit https://github.com/chutten/browser/commit/161b3e5ad0b8e3b7aaa67dc6bfb1661a966f1163
    ...
    Webview.prototype.setGeometry = function (x, y, width, height) {
        qnx.callExtensionMethod("webview.setGeometry", id, x, y, width, height);
    };
