...
webview = function () {
     ...
     */ 
    this.prototype.create = function (onComplete) {
     ...
     */ 
    this.prototype.foreground = function () {
     ...
     */ 
    this.prototype.background = function () {
     ...
     */ 
    this.prototype.destroy = function (onComplete) {
     ...
     */ 
    this.prototype.executeJavascript = function (js) {
