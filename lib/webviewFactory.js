...
Webview.prototype.removeEventListener = function (eventType, eventListener) {
    webkitEvent.removeEventListener({id: this.id, eventType: eventType}, eventListener);
};

/**
 * @description Removes all registered listeners for a given event
 */
Webview.prototype.removeAllEventListeners = function (eventType) {
...
Webview.prototype.dispatchEvent = function (eventType, args) {
    webkitEvent.emit({id: this.id, eventType: eventType}, args);
};
